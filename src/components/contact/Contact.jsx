            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">sarnendu1@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+918013024559</span>
                        
                        <a href="https://wa.me/+918013024559" target="_blank" rel='noreferrer' className="contact__button">
                        Send Message{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
