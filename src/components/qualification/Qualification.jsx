                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Maulana Abul Kalam Azaz University Of Technology</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon calendar-icon" />
                                2018-2021
                            </div>
                        </div>
                        <div>
                    ...
                    */}
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">Techpranee</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon calendar-icon" />
                                01/11/2021 - 31/04/2022
                            </div>
                        </div>
                    </div> 
                    {/* <div className="qualification__data">
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Senior React Developer</h3>
                            <span className="qualification__subtitle">Mobillor Technologies Pvt. Ltd</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon calendar-icon" />
                                01/05/2022 - Present
                            </div>
